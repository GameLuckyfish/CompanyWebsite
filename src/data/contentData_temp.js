export const contentData = {
    ...
    planning: [
        ...
        },
        {
            ...
            enDescription: "1.  **Existing Similar Content and Market Status:**<br>The current mobile game market is dominated by hybrid genres combining tower defense and RTS elements, such as 'Arknights' and 'Clash Royale', generating high revenue. According to 2024 market analysis, this strategy game genre forms a huge market worth approximately $18 billion, and users are demanding both deep growth systems like RPGs and the fun of strategic control. However, most games rely on auto-battle or lack depth in control, failing to fully satisfy hardcore strategy users.<br><br>2.  **Differentiation from Existing Content:**<br>Horde Defense Squad has a clear differentiation at this point. Our game is based on the intuitive fun of growth and defense in tower defense, but implements the 'real-time squad control' experience of traditional RTS games like StarCraft, optimized for the mobile environment. Users can experience the fun of micro-control, such as directly selecting and moving multiple units, and precisely targeting key enemy units, beyond simply using skills. This provides deep strategy and operational enjoyment that existing games could not provide, accurately targeting the 'gap' in the market.<br><br>3.  **Competitiveness and Appeal Compared to Other Content:**<br>The core competitiveness of Horde Defense Squad is 'strategic freedom' and 'continuous growth experience'. Users are not passive observers, but active commanders who dominate the battlefield. This provides high immersion and a sense of accomplishment, inducing users to play long-term. In addition, RPG elements that combine collected units and enhance traits present clear growth goals, providing strong motivation for users to continuously invest time and money in the game. Ultimately, our game combines the popularity of tower defense with the depth of RTS, possessing a unique appeal that can satisfy both light and hardcore users. This will be a key foundation for stable initial user acquisition and long-term box office success.<br><br><strong>References:</strong>\n                                <ul>\n                                    <li><a href='https://www.businessresearchinsights.com/market-reports/strategy-games-market-108233' target='_blank'>businessresearchinsights.com</a></li>\n                                    <li><a href='https://apptunix.com/blog/mobile-game-market-size/' target='_blank'>apptunix.com</a></li>\n                                    <li><a href='https://sensortower.com/blog/state-of-mobile-gaming-2024' target='_blank'>sensortower.com</a></li>\n                                </ul>"
        },
        {
            id: "revenue-model-card",
            koTitle: "수익 모델",
            enTitle: "Revenue Model",
            image: null,
            koDescription: "Horde Defense Squad는 유저의 플레이 경험을 해치지 않으면서도 안정적인 수익을 창출할 수 있는 다각화된 BM(Business Model)을 채택했습니다. 핵심 수익 모델은 다음과 같습니다.<br><br>1.  **인앱 구매 (In-App Purchase):**<br>    *   **유닛 성장 가속:** 더 빠른 유닛 성장과 합성을 원하는 유저들을 위한 재화(골드, 다이아) 및 아이템 판매.<br>    *   **기간 한정 이벤트 상품:** 특정 기간에만 구매할 수 있는 특별 유닛, 스킨, 패키지 상품 등을 통해 구매 욕구를 자극합니다.<br>2.  **리워드 광고 (Rewarded Ads):**<br>    *   **유저 선택적 광고 시청:** 유저가 자신의 필요에 의해 광고를 시청하고, 그 대가로 게임 내 재화나 아이템(예: 추가 유닛 뽑기권, 보너스 골드)을 얻는 시스템입니다. 이는 특히 인앱 결제에 부담을 느끼는 유저들에게 긍정적인 경험을 제공하며, 중국 및 동남아 시장에서 선호되는 방식입니다.<br><br>이러한 하이브리드 수익 모델은 유저의 성향에 맞는 다양한 선택지를 제공함으로써 결제 장벽을 낮추고, 장기적으로 안정적인 수익 구조를 확보하는 데 기여할 것입니다.",
            enDescription: "Horde Defense Squad has adopted a diversified BM (Business Model) that can generate stable revenue without harming the user's gameplay experience. The core revenue models are as follows:<br><br>1.  **In-App Purchase:**<br>    *   **Accelerated Unit Growth:** Sales of currency (gold, diamonds) and items for users who want faster unit growth and merging.<br>    *   **Limited-Time Event Items:** Stimulate purchase desire through special units, skins, and package deals available only for a specific period.<br>2.  **Rewarded Ads:**<br>    *   **User-Opt-in Ad Viewing:** A system where users choose to watch ads in exchange for in-game currency or items (e.g., extra unit draw tickets, bonus gold). This provides a positive experience, especially for users who are hesitant about in-app purchases, and is a preferred method in markets like China and Southeast Asia.<br><br>This hybrid revenue model will contribute to lowering the payment barrier and securing a stable long-term revenue structure by providing various options tailored to user preferences."
        },
        {
            id: "global-strategy-card",
            koTitle: "글로벌 진출 전략",
            enTitle: "Global Strategy",
            image: null,
            koDescription: "Horde Defense Squad는 기획 단계부터 글로벌 시장, 특히 성장 잠재력이 높은 중국 본토 및 동남아 시장을 주요 타겟으로 설정했습니다. 이를 위한 핵심 전략은 다음과 같습니다.<br><br>1.  **저용량 및 최적화:** 모바일 네트워크 환경이 다양하고 디바이스 사양이 낮은 지역에서도 원활하게 플레이할 수 있도록 게임 용량을 최소화하고, 철저한 최적화 작업을 진행합니다.<br>2.  **현지화 및 문화적 접근:** 단순 번역을 넘어, 각 지역의 문화적 특성과 유저 선호도를 반영한 현지화 전략을 수립합니다. 특히 중국 시장에서 선호되는 위챗 미니게임, 틱톡 게임 등 저용량 게임 플랫폼 진출을 적극적으로 고려합니다.<br>3.  **리워드 광고 중심의 수익 모델:** 인앱 결제에 대한 부담이 적고 리워드 광고에 대한 수용도가 높은 시장 특성을 고려하여, 리워드 광고를 핵심 수익 모델 중 하나로 적극 활용합니다. 이는 유저 유입을 확대하고 장기적인 수익성을 확보하는 데 기여할 것입니다.<br>4.  **전략적 파트너십:** 각 지역의 퍼블리셔 및 플랫폼 사와의 전략적 파트너십을 통해 시장 진입 장벽을 낮추고, 효과적인 마케팅 및 운영을 추진합니다.<br><br>이러한 전략들을 통해 Horde Defense Squad는 글로벌 시장에서 성공적으로 안착하고, 지속적인 성장을 이어나갈 것입니다.",
            enDescription: "Horde Defense Squad has been planned from the outset to target the global market, especially mainland China and Southeast Asia, which have high growth potential. The core strategies for this are as follows:<br><br>1.  **Low Capacity and Optimization:** Minimize game capacity and thoroughly optimize it so that it can be played smoothly even in regions with diverse mobile network environments and low device specifications.<br>2.  **Localization and Cultural Approach:** Beyond simple translation, we will establish a localization strategy that reflects the cultural characteristics and user preferences of each region. We will actively consider entering low-capacity game platforms such as WeChat mini-games and TikTok games, which are preferred in the Chinese market.<br>3.  **Rewarded Ad-Centric Revenue Model:** Considering the market characteristics where there is less burden on in-app purchases and a high acceptance of rewarded ads, we will actively utilize rewarded ads as one of our core revenue models. This will contribute to expanding user inflow and securing long-term profitability.<br>4.  **Strategic Partnerships:** Each region's publishers and platform companies will be strategically partnered with to lower market entry barriers and promote effective marketing and operations."
        }
    ]
};